//------------------------------------------------------------------------------
// ToDAE auto-generated model object from schema 1.4.1
...
namespace Collada141
{
    ...
    public partial class COLLADA
    {
        ...
        /// <summary>
        /// Items XML二级节点
        /// <para>同级节点：asset（描述）、library_geometries（几何对象）、library_materials（材质）、library_effects（特效）、library_lights（灯光）、library_meshes（网格对象）、library_images（图片）、library_visual_scenes（可视化场景）、library_animations（动作）、library_controllers（控制器）。</para>
        /// </summary>
    ...
    public class float_array
    {
        ...
        private short digitsField;  //数字字段
        private string idField;

        private short magnitudeField;   //大小、量级、光度、重要字段
        private string nameField;
    ...
    /// 几何数据
    /// <para>同级节点：asset（描述）、library_geometries（几何对象）、library_materials（材质）、library_effects（特效）、library_lights（灯光）、library_meshes（网格对象）、library_images（图片）、library_visual_scenes（可视化场景）、library_animations（动作）、library_controllers（控制器）。</para>
    /// <para>子节点：asset、geometry、extra</para>
    /// <para>属性：id、name</para>
    /// </summary>
    [GeneratedCode("xsd", "4.0.30319.1")]
    [Serializable]
    [DebuggerStepThrough]
    ...
    /// <summary>
    /// 几何图形
    /// <para>父节点：library_geometries（几何数据）</para>
    /// <para>子节点：asset、extra</para>
    /// <para>geometry属性：id、name、item</para>
    /// </summary>
    [GeneratedCode("xsd", "4.0.30319.1")]
    [Serializable]
    [DebuggerStepThrough]
    ...
    /// mesh网格节点
    /// <para>父节点：</para>
    /// <para>子节点：source、vertices、items、extra</para>
    /// </summary>
    [GeneratedCode("xsd", "4.0.30319.1")]
    [Serializable]
    [DebuggerStepThrough]
